...
func _1557732988_initialize_dbDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1557732988_initialize_db.down.sql", size: 72, mode: os.FileMode(0664), modTime: time.Unix(1649677591, 0)}
...
func _1557732988_initialize_dbUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1557732988_initialize_db.up.sql", size: 278, mode: os.FileMode(0664), modTime: time.Unix(1649677591, 0)}
...
func staticGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "static.go", size: 178, mode: os.FileMode(0664), modTime: time.Unix(1649677591, 0)}
