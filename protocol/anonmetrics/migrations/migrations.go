...
func _1619446565_postgres_make_anon_metrics_tableDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1619446565_postgres_make_anon_metrics_table.down.sql", size: 24, mode: os.FileMode(0664), modTime: time.Unix(1649677591, 0)}
...
func _1619446565_postgres_make_anon_metrics_tableUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1619446565_postgres_make_anon_metrics_table.up.sql", size: 443, mode: os.FileMode(0664), modTime: time.Unix(1649677591, 0)}
...
func docGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "doc.go", size: 380, mode: os.FileMode(0664), modTime: time.Unix(1649677591, 0)}
