...
func configPublicChainAccountsJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/public-chain-accounts.json", size: 307, mode: os.FileMode(0664), modTime: time.Unix(1649677591, 0)}
...
func configStatusChainAccountsJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/status-chain-accounts.json", size: 543, mode: os.FileMode(0664), modTime: time.Unix(1649677591, 0)}
...
func configTestDataJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "config/test-data.json", size: 84, mode: os.FileMode(0664), modTime: time.Unix(1649677591, 0)}
