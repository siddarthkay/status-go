...
func _0001_accountsDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0001_accounts.down.sql", size: 21, mode: os.FileMode(0664), modTime: time.Unix(1649677591, 0)}
...
func _0001_accountsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "0001_accounts.up.sql", size: 163, mode: os.FileMode(0664), modTime: time.Unix(1649677591, 0)}
...
func _1605007189_identity_imagesDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1605007189_identity_images.down.sql", size: 29, mode: os.FileMode(0664), modTime: time.Unix(1649677591, 0)}
...
func _1605007189_identity_imagesUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1605007189_identity_images.up.sql", size: 268, mode: os.FileMode(0664), modTime: time.Unix(1649677591, 0)}
...
func _1606224181_drop_photo_path_from_accountsDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1606224181_drop_photo_path_from_accounts.down.sql", size: 892, mode: os.FileMode(0664), modTime: time.Unix(1649677591, 0)}
...
func _1606224181_drop_photo_path_from_accountsUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1606224181_drop_photo_path_from_accounts.up.sql", size: 866, mode: os.FileMode(0664), modTime: time.Unix(1649677591, 0)}
...
func _1648646095_image_clockDownSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1648646095_image_clock.down.sql", size: 939, mode: os.FileMode(0664), modTime: time.Unix(1650612512, 0)}
...
func _1648646095_image_clockUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1648646095_image_clock.up.sql", size: 69, mode: os.FileMode(0664), modTime: time.Unix(1650612512, 0)}
...
func _1649317600_add_color_hashUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1649317600_add_color_hash.up.sql", size: 201, mode: os.FileMode(0664), modTime: time.Unix(1649677591, 0)}
